...
public class QueryResult implements Iterable<List<String>> {
	...
	public QueryResult join(ClosableIterator<String[]> queryResult,
			String var0, String var1, String var2) throws IOException {
		try {
	...
	public QueryResult join(ClosableIterator<String[]> queryResult,
			String var0, String var1) throws IOException {
		try {
			int index0 = this.resultVars.indexOf(var0);
			int index1 = this.resultVars.indexOf(var1);
	...
	public QueryResult join(ClosableIterator<String> queryResult, String var)
			throws IOException {
		try {
